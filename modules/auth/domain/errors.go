...
var (
	...
	ErrOAuthFlowUnavailable = errors.New("auth: oauth flow store not configured")
	ErrInvalidState         = errors.New("auth: invalid oauth state")
	ErrOAuthDenied          = errors.New("auth: oauth authorization denied")
	ErrOAuthCallback        = errors.New("auth: oauth callback failed")
