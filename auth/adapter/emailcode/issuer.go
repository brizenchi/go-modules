...
// CodeRateLimitStore, and sends it through pkg/email's SendService
...
//
// pkg/email's *email.Module satisfies this implicitly because its
...
// type, decoupling this adapter from pkg/email's import path.
