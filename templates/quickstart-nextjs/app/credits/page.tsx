...
export default function CreditsPage() {
  ...
  const labels: Record<string, { en: string; zh: string }> = { grant: { en: "Received", zh: "获得积分" }, consume: { en: "Used", zh: "消费积分" }, refund: { en: "Returned", zh: "积分退回" }, expire: { en: "Expired", zh: "积分过期" }, expiry: { en: "Expired", zh: "积分过期" } };
