...
[![Go Reference](https://pkg.go.dev/badge/github.com/brizenchi/go-modules/email.svg)](https://pkg.go.dev/github.com/brizenchi/go-modules/email)
...
```bash
go get github.com/brizenchi/go-modules/email
```
...
```go
import "github.com/brizenchi/go-modules/email/adapter/resend"
...
```go
import "github.com/brizenchi/go-modules/email/adapter/smtp"
